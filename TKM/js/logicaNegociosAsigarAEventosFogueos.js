...
function getIdAlumnosXFogueo(pId) {
  var aIdsAlumno = [];
  var peticion = $.ajax({
    url: "services/pa_listar_id_alumnos_por_fogueo.php",
    type: "get",
    data: {
      'id': pId
    },
...
function asignarAlumnoFogueo(pidAlumno, pIdFogueo) {
  var peticion = $.ajax({
    url: "services/pa_asignar_alumno_fogueo.php",
    type: "post",
    data: {
      'pid_fogueo': pIdFogueo,
...
function eliminarAlumnoEnBD(pIdAlumno, pIdFogueo) {
  var peticion = $.ajax({
    url: "services/pa_eliminar_alumno_fogueo.php",
    type: "post",
    data: {
      'pid_fogueo': pIdFogueo,
      'pid_alumno': pIdAlumno
...
function getIdLugarXFogueo(pId) {
  var aIdLugar = [];
  var peticion = $.ajax({
    url: "services/pa_listar_id_lugar_por_fogueo.php",
    type: "get",
    data: {
      'id': pId
    },
...
function asignarLugarFogueo(pIdLugar, pIdFogueo) {
  var peticion = $.ajax({
    url: "services/pa_asignar_lugar_fogueo.php",
    type: "post",
    data: {
      'pid_fogueo': pIdFogueo,
      'pid_alumno': pIdLugar
...
function eliminarLugarEnBD(pIdLugar, pIdFogueo) {
  var peticion = $.ajax({
    url: "services/pa_eliminar_lugar_fogueo.php",
    type: "post",
    data: {
      'pid_fogueo': pIdFogueo,
      'pid_alumno': pIdLugar
...
function getIdOrganizacionXFogueo(pId) {
  var aIdOrganizacion = [];
  var peticion = $.ajax({
    url: "services/pa_listar_id_organizacion_por_fogueo.php",
    type: "get",
    data: {
      'id': pId
    },
...
function asignarOrganizacionFogueo(pIdOrganizacion, pIdFogueo) {
  var peticion = $.ajax({
    url: "services/pa_asignar_organizacion_fogueo.php",
    type: "post",
    data: {
      'pid_fogueo': pIdFogueo,
...
function eliminarOrganizacionEnBD(pIdOrganizacion, pIdFogueo) {
  var peticion = $.ajax({
    url: "services/pa_eliminar_organizacion_fogueo.php",
    type: "post",
    data: {
      'pid_fogueo': pIdFogueo,
      'pid_alumno': pIdOrganizacion
...
function getIdPatrocinadoresXFogueo(pId) {
  var aIdsPatrocinadores = [];
  var peticion = $.ajax({
    url: "services/pa_listar_id_patrocinadores_por_fogueo.php",
    type: "get",
    data: {
      'id': pId
    },
...
function asignarPatrocinadorFogueo(pIdPatrocinador, pIdFogueo) {
  var peticion = $.ajax({
    url: "services/pa_asignar_patrocinador_fogueo.php",
    type: "post",
    data: {
      'pid_fogueo': pIdFogueo,
...
function eliminarPatrocinadorEnBD(pIdPatrocinador, pIdFogueo) {
  var peticion = $.ajax({
    url: "services/pa_eliminar_patrocinador_fogueo.php",
    type: "post",
    data: {
      'pid_fogueo': pIdFogueo,
      'pid_alumno': pIdPatrocinador

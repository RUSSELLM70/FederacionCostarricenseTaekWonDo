...
//       'ptelefono': pinfoAcademia[1],
//       'pcorreo': pinfoAcademia[2],
...
function activar(pId) {
  var peticion = $.ajax({
    url: "services/activarAcademia.php",
    type: "post",
    contentType: 'application/x-www-form-urlencoded;charset=ISO-8859-15',
    dataType: 'json',
    async: false,
    ...
    success: //function(respuesta){
      alertify.success("Academia activada exitosamente"),
    //},
    error: function(request, error) {}
  });
}
...
function desactivar(pId) {
  var peticion = $.ajax({
    url: "services/desactivarAcademia.php",
    type: "post",
    contentType: 'application/x-www-form-urlencoded;charset=ISO-8859-15',
    dataType: 'json',
    async: false,
    ...
    success: //function(respuesta){
      alertify.success("Academia desactivada exitosamente"),
    //},
    error: function(request, error) {}
  });
}
